...
const testArr =
{
  "fivepm": [
    ...
    // ["16:43,15:30,15:50,15:50;5,4,3,3;S2>N5>S3>S4>S1", "12/11/2024"],
    ...
    // ["14:40,15:30,16:30,16:45;4,3,3,2;S1>S2>N5>S4>S3", "12/22/2024"],
    ...
    // ["16:44,15:50,15:50,15:55;4,3,2,2;N5>S2>S3>S4>S1", "12/31/2024"],
    // ["16:44,15:50,15:50,15:55;4,3,2,2;N5>S2>S3>S4>S1", "1/1/2025"],
  ...
  "sevenpm": [
    ["17:07,17:03,18:00,18:05;4,4,3,1; S3>S2>N1>S4>N2>N5>N3>N4", "1/24/2025"],
    ...
    ["18:45,18:46,18:46,18:45;7,6,6,3;N1>N2>N3>N4>N1>N2>N3>N4>N5>S3>S4", "12/16/2024 Interesting case. Probably should take into account seconds in the final add in order to break ties. Or keep note of which was added first."], // 12/16/2024
    ...
    ["17:58,18:55,17:58,18:36;5,5,3,2;N1>S2>S4>N2>N3>N4>N5>S3", "12/29/2024 break ties with CLR"], // 12/29/2024
    ...
    ["18:46,17:30,17:40,18:38;6,5,5,2;N1>N2>N3>N4>N5>S3>S2>N1>N2>S4>N3>N4>N5>S3", "01/07/2025"], // 01/07/2025
    ["18:40,15:46,16:45,17:48;6,3,3,1;S3>S4>N1>N5>N2>N3>N4>S2", "01/08/2025"], // 01/08/2025
    ["18:39,19:00,18:26,18:24;6,5,5,2;N1>N2>N3>N4>N5>S2>S3>N1>N2>S4>N3>N4>N5>S2>S3", "01/09/2025"], // 01/09/2025
    ...
    ["17:32,18:12,18:25,18:19;6,5,5,2;N1>N2>N3>N4>S2>S3>N5>N1>N2>S4>N3>N4>S2>S3>N5", "01/13/2025"], // 01/13/2025
    ...
    ["18:15,18:39,18:23,18:39;5,5,4,3; N1>N2>S2>N3>N4>S3>S4>N1>N2>S2>N3>N4>S3>S4>N5", "1/17/2025"],
    ...
    ["18:08,18:14,18:46,18:08;6,5,5,2; N1>N2>N3>N4>S2>N5>S3>N1>N2>S4>N3>N4>S2>N5>S3", "1/21/2025"],
...
describe('template spec', () => {
  ...
  it(`Fill out all timestamps and number of admissions test loop`, () => {
    ...
    let count = 1;
    for (let i = 0; i < testArr.fivepm.length; i++) {
      const splitArr = testArr.fivepm[i][0].split(";");
      ...
      cy.get('#orderofadmissions_output') // Replace 'yourElementId' with the actual ID of the element
        .then(($el) => {
          ...
          if (generatedFromAutomation && generatedFromAutomation == output.trim()) {
            ...
            console.log("[" + count + "] 5PM "+testArr.fivepm[i][1] + " -- NO MATCH");
            console.log("Data:        ", testArr.fivepm[i][0].split(";").slice(0, testArr.fivepm[i][0].split(";").length - 1).join("; "));
            console.log("Actual:      ", $el.text());
    ...
    for (let i = 0; i < testArr.sevenpm.length; i++) {
      const splitArr = testArr.sevenpm[i][0].split(";");
      ...
      cy.get('#orderofadmissions_output') // Replace 'yourElementId' with the actual ID of the element
        .then(($el) => {
          ...
          if (generatedFromAutomation && generatedFromAutomation == output.trim()) {
            ...
            console.log("[" + count + "] 7PM ", testArr.sevenpm[i][1] + " -- NO MATCH");
            console.log("Data:        ", testArr.sevenpm[i][0].split(";").slice(0, testArr.sevenpm[i][0].split(";").length - 1).join("; "));
            console.log("Actual:      ", $el.text());
            console.log("Expected:    ", output);
            count++;
            // resArr.push(":::::: NO MATCH");
