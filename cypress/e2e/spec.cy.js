...
// "19:00;17:31,18:01,18:30,18:45;6,4,6,3;N1>N2>S3>N3>N4>S2>N1>N2>S3>N3>N4>S4>N5", //scenario 1
// "19:00;17:31,18:01,18:30,18:45;6,5,5,2;N1>N2>N3>N4>S2>N5>N1>N2>S4>N3>N4>N5" //scenario 2

// "19:00;17:31,18:01,18:30,18:45;6,6,5,2;N1>N2>N3>N4>S2>N5>N1>N2>S4>N3>N4>N5",
...
describe('template spec', () => {
  ...
  it(`Fill out all timestamps and number of admissions test loop`, () => {
      ...
      cy.get('#endoutput') // Replace 'yourElementId' with the actual ID of the element
        .then(($el) => {
          ...
          if (generatedFromAutomation && generatedFromAutomation == output.trim()) {
            ...
            console.log(testArrFourPM[i] + "::::::" + $el.text() + "----NO MATCH");
    ...
    // cy.wrap(logs).should('deep.equal', ['First message', 'Second message', 'Third message']);

    // console.log(logs);
    // Optional: Print all collected logs in one go
    // cy.log('Collected logs: ' + logs.join(', '));
  });
})
