...
// "19:00;17:31,18:01,18:30,18:45;6,6,6,3;N1>N2>N3>N4>S2>N1>N2>N3>S3>N4>S4>N5",

// "19:00;17:31,18:01,18:30,18:45;6,5,5,2;N1>N2>N3>N4>S2>N5>N1>N2>S3>N3>S4>N4",
...
// "17:00;16:35,15:20,15:30,15:30;4,2,2,2;S2>N5>S3>S4>S1", //1/2/2025 -- wrong
   
// "17:00;15:20,16:20,16:30,16:45;4,4,3,3;S1>N5> S2>S3>S4", //1/3/2025 -- wrong
...
//   //  "17:00;16:05,16:45,14:40,15:30;5,4,2,2;S3>N5>S4>S1>S2", //1/6/2025  need to fix ties  -- wrong
...
// "17:00;16:40,16:35,14:55,15:20;5,4,3,2;N5>S3>S4>S2>S1", //1/11/2025  STRANGE ONE -- wrong
...
// "17:00;16:57,15:35,16:05,15:35;5,4,3,2;N5>S4>S2>S3>S1", //1/15/2025 -- wrong
...
//    "19:00;17:37,18:17,17:11,18:28;6,4,3,2;S4>N1>N2>N3>N4>S2>S3>N5", //12/10/2024 -- wrong
  ...
  //  "19:00;17:31,18:40,18:43,18:49;6,5,5,2;N1>N2>N3>N4>S2>S3>S4>N5", //12/14/2024 
  // //  "19:00;18:45,18:46,18:46,18:45;7,6,6,3;N1>N2>N3>N4>S2>N5>S3>S4", //12/16/2024 Interesting case.  Probably should take into account seconds in the final add in order to break ties. Or keep note of which was added first. -- wrong
...
describe('template spec', () => {
  ...
  it(`Fill out all timestamps and number of admissions test loop`, () => {
    ...
    for (let i = 0; i < testArrFourPM.length; i++) {
      ...
      cy.get('#endoutput').should('have.text', output);
      cy.get('#orderofadmissions_output').should('have.text', output);
      
      // cy.get('#endoutput') // Replace 'yourElementId' with the actual ID of the element
      //   .then(($el) => {

      //     if ($el.text() && $el.text().replace(/\(.*?\)/g, "").trim() == output.trim()) {
